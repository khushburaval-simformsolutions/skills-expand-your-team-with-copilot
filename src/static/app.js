  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficultyFilter === "") {
        // "All Levels" selected - show everything
      } else {
        // A specific level selected - only show activities with that difficulty
    ...
    if (currentGroupBy === "category") {
      ...
      categoryOrder.forEach((category) => {
        ...
        const cardsContainer = groupSection.querySelector(".activity-group-cards");
        Object.entries(groups[category]).forEach(([name, details]) => {
